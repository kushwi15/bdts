          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">6th Floor, Suite No: 10, Gamma Block, Sigma Soft Tech Park</span>
              </li>
...
<div className="flex">
  <input 
    ...
    className="bg-dark-700 text-white px-2 py-2 rounded-l outline-none border border-dark-500 focus:border-primary-500 transition-colors w-48" // Added w-48 for width control
  />
  <button 
    type="submit" 
