...
const CustomCursor: React.FC = () => {
  ...
  return (
    <>
      <div 
        className={`custom-cursor ${hidden ? 'opacity-0' : 'opacity-100'} ${clicked ? 'scale-75' : 'scale-100'} ${linkHovered ? 'scale-150' : ''}`}
        style={{
          left: `${position.x}px`,
          top: `${position.y}px`,
          backgroundColor: linkHovered ? 'rgba(255,204,38,0.8)' : 'rgba(255,157,38,0.8)'
        }}
      />
      <div 
